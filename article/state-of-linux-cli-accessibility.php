  ...
  <body>
    ...
    <main id="content">
      ...
      ?>
       <article>
<h3>Introduction</h3>
<p>A long, long time ago, I wrote an article about <a href="/articles/state-of-linux-accessibility.php">The State of Linux Desktop Accessibility</a> and how I was and am continuously use linux for my daily computing and developing needs. But one of the questions I know even I asked was: <strong>what is linux command line accessibility like?</strong> Well, this article's going to answer that.</p>
