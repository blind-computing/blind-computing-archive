...
<p>Okay, okay, that's enough! Now, let's get onto what you've all come here for: TTY accessibility.</p>
<h3>Non GUI Linux Accessibility</h3>
<h4>Speakup</h4>
<p>Speakup is the kernel modual that makes linux TTY accessibility possible. You can find its home page at <a href="https://www.linux-speakup.org">This Link to the Speakup Home Page</a>, where you will find information, some useful, some really, really not (as it pertains to obscenely  expensive speech synthasizers that nobody has any more) about how to get speakup running and some basic commands.</p>
<p>Really though, this page isn't needed, as speakup works exactly how you'd expect it to work. Of course, if you want to learn how to use features like built-in copy and paste, the instructions on this page'll help you out, but for the most part, things should just work.</p>
<p>Things will also just work because speakup is now integrated into the kernel of almost all distributions, so all you need to do is install a synthasizer, like ...</p>
<h4>ESpeakup</h4>
<p>ESpeakup is a common plugin for speakup. IT provides a bridge between speakup and the very common espeak speech synthasizer that everyone in the free assistive tech community uses, mostly due to its speed. This allows you to use speakup on a modern system where you have more than enough power to synthasise speech in software, instead of throwing yourself back in the 90s, when you had to buy a speech synthasizer card and install drivers. It is a very basic modual, often under the name <q>"<strong>espeakup</strong>"</q> in most package managers and all it takes is an install to get it working.</p>
