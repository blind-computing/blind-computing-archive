...
<p>So, like I think most geeks would do ...</p>
<h3>I decided to get a mac!</h3>
<p>Voiceover, the built-in screen reader on the mac, was very good, but again, the mac desktop still didn't seem customisable enough. It wasn't a developer's desktop, just a standard, consumer focused desktop experience.</p>
...
<p>Well, after about 4 years of trying, I have to say that my situation, as well as, I can imagine, the situations of various other people, has changed.</p>

<h3>debian - the ideal solution</h3>

<p>Yes. Somewhat surprisingly to me, plain old debian was one of the best options. For a start, debian has a command line speach installer accessible at least for the net install CD image and the main debian ISOs. </p>
...
<p>Because I use orca as my screen reader, which is based on gnome, meaning it works best with gtk applications, I have had some quite major problems with qt  application support. Before anyone tells me, yes i've heard of jovie for kde, but I honestly can't wrap my head around how to set it up properly or even what on earth it is. I have qt accessability enabled and that gives me some support (applications like kate and kwrite work), but if I try to run, say, kdenlive, I get no output from orca. I would love to see someone work on this more, as it is the only thing holding me back right now.</p>
<h3>conclusion</h3>
<p>To some up, I honestly think that linux is more accessible than windows. I can't, as far as I know, install windows with a screen reader (edit: this is certainly possible, video coming soon, but it is in no way made possible by microsoft themselves). Also, the gtk standard is pretty common, so I think that most applications are accessible, whereas on windows or mac, some software providers (microsoft office for mac) decide to use a none standard way of laying out widgets. Therefor, I have more of a chance of either getting accessability support out of the box with linux apps, or somehow being able to modify settings to get it to work.</p>

<p>I hope you enjoyed reading this, but that's all for now. I may publish more articles about this subject in the future, especially how to get things working articles, but you'll just have to wait and see. <a href="/article/state-of-linux-cli-accessibility.php">Linux command line accessibility</a> is quite high up on the list right now</p>
<i>Mikey</i>
      </article>
      </main>
  </body>
