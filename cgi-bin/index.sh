...
<p>The best way is to submit a pull request to the <a href="https://github.com/mcb2003/blind-computing" target="_blank" title="opens in a new tab">github repository</a>. These files are automatically uploaded to the site every thirty minutes, so after the pull request has been accepted, you should weight a while to see the changes. That is, unless I'm nice and decide to force a re-upload.</p>
<h2>Note</h2>
<p>We reccommend you view this site in firefox if you're on a desktop, as this is what it's been tested in. Other browsers might work, but in general, mozilla's offering is more accessible anyway.</p>
</div></body></html>
END-OF-CAT
