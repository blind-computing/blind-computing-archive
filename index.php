  ...
  <body>
    ...
    <main id="content">
        <div class="half-width">
          <div class="padinner">
            <section><h2>What is Blind Computing?</h2>
            ...
            <section><h2>how to contribute</h2>
            <p>Please see the <a href="/contributing.php">contributing page</a> for more information.</p></section>
          <section><h2>Note</h2>
          <p>We recommend you view this site in mozilla firefox, found at <a href="https://firefox.com/download">the firefox download page</a>, if you're on a computer. Other browsers might work, but in general, firefox is more accessible anyway.</p></section>
        </div></div>
        <div class="halfwidth">
          <div class="padinner">
