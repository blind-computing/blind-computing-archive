...
?>
    ...
    <main id="content">
        <div class="half-width"margin-top: 0;">
          <div class="padinner" style="padding-top: 0;">
            <section aria-labelledby="what-is-bc-heading">
            <h2 id="what-is-bc-heading">What is Blind Computing?</h2>
            ...
            <h2 id="contributing-heading">how to contribute</h2>
            <p>Please see the <a href="/contributing.php">contributing page</a> for more information.</p>
          </section>
          <section aria-labelledby="browser-support-heading"><details>
            <summary><h2 id="browser-support-heading">Note on Browser Support</h2></summary>
